...
char hookbossargs[MAX_WEAPON_ARG_LENGTH]; char hookplayersargs[MAX_WEAPON_ARG_LENGTH];
...
char ScoutSpeed[MAXPLAYERS+1]; char SoldierSpeed[MAXPLAYERS+1]; char PyroSpeed[MAXPLAYERS+1]; char DemoSpeed[MAXPLAYERS+1]; char HeavySpeed[MAXPLAYERS+1];
char EngineerSpeed[MAXPLAYERS+1]; char MedicSpeed[MAXPLAYERS+1]; char SniperSpeed[MAXPLAYERS+1]; char SpySpeed[MAXPLAYERS+1];
